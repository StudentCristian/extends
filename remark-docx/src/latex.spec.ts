...
describe("parse", () => {
    ...
    describe("command", () => {
        ...
        it("greek2", () => {
            expect(parse("\\varepsilon\\vartheta\\varrho\\varsigma\\varphi")).toMatchSnapshot();
        });
        it("greek3", () => {
            expect(parse("\\Gamma\\Delta\\Theta\\Lambda\\Xi\\Pi\\Sigma\\Upsilon\\Phi\\Psi\\Omega")).toMatchSnapshot();
        });
    });
});
